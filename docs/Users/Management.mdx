...
- For tokens and client registration, see the Admin UI pages:
  - Tokens: [docs/Admin UI/Admin - Dashboard.mdx](@site/docs/Admin%20UI/Admin%20-%20Dashboard.mdx)
  - Client Registration: linked from the Navbar in Dashboard
  - Validation modes and profiles: [docs/Install Couchbase FHIR Server/Validation.md](@site/docs/Install%20Couchbase%20FHIR%20Server/Validation.md)
